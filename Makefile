#############################################################################
# Makefile for building: pdf_annotate_extract
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  pdf_annotate_extract.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile pdf_annotate_extract.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -isystem /usr/include/poppler/qt5 -isystem /usr/include/qt -isystem /usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/lib -lpoppler-qt5 -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		pdf_annotate_extract.pro main.cpp \
		extractannotation.cpp
QMAKE_TARGET  = pdf_annotate_extract
...
Makefile: pdf_annotate_extract.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		pdf_annotate_extract.pro \
		/usr/lib/libQt5Core.prl
	$(QMAKE) -o Makefile pdf_annotate_extract.pro
...
dist: 
	@test -d .tmp/pdf_annotate_extract1.0.0 || mkdir -p .tmp/pdf_annotate_extract1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/pdf_annotate_extract1.0.0/ && $(COPY_FILE) --parents extractannotation.h .tmp/pdf_annotate_extract1.0.0/ && $(COPY_FILE) --parents main.cpp extractannotation.cpp .tmp/pdf_annotate_extract1.0.0/ && (cd `dirname .tmp/pdf_annotate_extract1.0.0` && $(TAR) pdf_annotate_extract1.0.0.tar pdf_annotate_extract1.0.0 && $(COMPRESS) pdf_annotate_extract1.0.0.tar) && $(MOVE) `dirname .tmp/pdf_annotate_extract1.0.0`/pdf_annotate_extract1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/pdf_annotate_extract1.0.0
...
main.o: main.cpp extractannotation.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

extractannotation.o: extractannotation.cpp extractannotation.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o extractannotation.o extractannotation.cpp
